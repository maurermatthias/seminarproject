...
public class RestClient
{
  ...
  public static void main (String[] args) throws Exception
  {
    ...
    returndata = RestClient.doHttpGet ("http://localhost:8080/restdemo/rest/sayhello");
    System.out.println (returndata);
    
    returndata = RestClient.doHttpGet ("http://localhost:8080/restdemo/rest/echoget?data=hellomultiverse");
    System.out.println (returndata);
    
    returndata = RestClient.doHttpPost("http://localhost:8080/restdemo/rest/echopost", "data=spongebob");
    System.out.println (returndata);
